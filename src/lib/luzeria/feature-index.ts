...
export const FEATURE_INDEX: FeatureEntry[] = [
  ...
  },
  {
    ...
    keywords: ["vendas", "lead", "leads", "funil", "crm", "oportunidade", "prospecção", "orçamento", "follow-up", "followup"],
  ...
  },
  {
    ...
    keywords: ["lixeira", "excluído", "excluido", "apagado", "restaurar", "recuperar", "desfazer exclusão", "lixo"],
  ...
  },
  {
    ...
    keywords: ["pagamento", "pagamentos", "cobrar", "cobrança do cliente", "vencimento", "mensalidade", "recebimento", "quem pagou"],
    to: "/configuracoes",
