...
export const FAQ: HelpFaqGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Se o site sair do ar, o que acontece com meus dados? Vocês têm backup?", a: "Fica tranquilo, seus dados não somem. Fazemos backup diário e automático de tudo, com camadas de proteção adicionais contra perda de dados — mesmo num problema sério, nada se perde. Uma instabilidade pontual é só isso: instabilidade, o site volta e seus clientes, conteúdos e arquivos continuam exatamente onde estavam." },
    ],
  },
];
