    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4"
      ...
      <div className="w-full max-w-sm bg-[#1C1C1C] border border-white/10 rounded-2xl p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <h3 className="text-base font-semibold text-white">
          Que tal integrar o Modo Criador com o seu Google Agenda?
        </h3>
        <p className="text-[13px] text-white/50 mt-2 leading-relaxed">
          Conecte sua conta e veja os compromissos de hoje direto aqui em Minhas Demandas — gravações, reuniões, tudo num só lugar.
        </p>
        <div className="flex gap-2 mt-6">
          ...
          <button onClick={connect} disabled={getGoogleCalendarAuthUrl.isPending}
            className="flex-1 px-3 py-2.5 rounded-lg text-sm font-semibold disabled:opacity-40"
