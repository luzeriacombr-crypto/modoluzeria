...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    desc: "Este checklist te guia nos primeiros passos: personalizar a marca da agência, conectar o Google Drive e trazer seus clientes. Ele some sozinho quando você terminar.",
    view: "admin",
  ...
  },
  {
    id: "sidebar",
    title: "Seus clientes",
    desc: "Aqui ficam os clientes da agência, separados por categoria. Clique em um pra abrir o mês dele. Passando o mouse num cliente aparecem atalhos: ficha, favoritar e um menu com renomear, cor, duplicar mês e arquivar.",
  ...
  {
    id: "cliente-board",
    title: "Dentro de um cliente",
    desc: "Cada cliente tem abas de Posts e Reels com os cards do mês. Clique num card pra abrir o detalhe: status, responsável, editor, prazo, arquivos, checklist e comentários — inclusive comentário por áudio, se preferir falar em vez de escrever.",
  },
  {
    id: "cliente-organizar",
    title: "Organizando o mês",
    desc: "Na ordem \"Personalizada\" você arrasta os cards pra mudar a posição. Cada card também tem um botão pra mover o post pra outro mês, e o \"Duplicar mês\" no topo repete a estrutura do mês atual no seguinte.",
  },
  {
    id: "cliente-feed",
    title: "Preview de Feed — o que o cliente vê",
    desc: "A aba \"Preview de Feed\" monta a grade como vai ficar no Instagram, e gera um link público pro seu cliente aprovar sem precisar de conta no sistema. É por aqui que a aprovação acontece.",
  },
  {
    id: "lixeira",
    title: "Apagou sem querer?",
    desc: "Post ou reel excluído fica 7 dias na Lixeira, dá pra restaurar inteiro — com comentários e arquivos. Depois disso some de vez.",
    descMobile: "Post ou reel excluído fica 7 dias na Lixeira, dá pra restaurar inteiro. No celular, toque no menu (☰) aqui embaixo e escolha Lixeira.",
    target: '[data-tour="nav-lixeira"]',
  ...
  },
  {
    ...
    desc: "Guarde links de vídeos e posts que servem de referência — geral pra agência ou separados por cliente.",
    descMobile: "Guarde links de vídeos e posts que servem de referência. No celular, toque no menu (☰) aqui embaixo e escolha Biblioteca.",
  ...
  },
  {
    id: "instagram",
    title: "Instagram",
    desc: "Conecte a conta do cliente e publique posts, reels e stories direto pelo app — na hora ou agendado.",
  ...
  },
  {
    id: "vendas",
    title: "Vendas",
    desc: "Um funil pros seus leads: novos, responder agora, follow-up, fechado e perdido. Ao marcar um lead como ganho, dá pra criar o cliente na hora — já com o primeiro mês montado.",
    descMobile: "Um funil pros seus leads, de \"novo\" até \"fechado\". No celular, toque no menu (☰) aqui embaixo e escolha Vendas.",
    target: '[data-tour="nav-vendas"]',
    mobileTarget: '[data-tour="mobile-menu-btn"]',
  ...
  },
  {
    ...
    desc: "Todos os clientes lado a lado: em que etapa da jornada cada um está, quando foi a última gravação, margem e pagamentos. É a tela pra bater o olho e ver quem precisa de atenção.",
    descMobile: "Todos os clientes lado a lado: etapa da jornada, última gravação, margem e pagamentos. No celular, toque no menu (☰) e escolha Visão Geral.",
    target: '[data-tour="nav-cliente"]',
    mobileTarget: '[data-tour="mobile-menu-btn"]',
    roles: ["master", "setor"],
  },
  {
    id: "financeiro",
    title: "Financeiro",
    desc: "Seu plano e faturas do Modo Criador, o programa de indicação e a revenda com a marca da sua agência.",
    descMobile: "Seu plano e faturas, indicação e revenda. No celular, toque no menu (☰) aqui embaixo e escolha Financeiro.",
  ...
  },
  {
    id: "equipe",
    title: "Equipe",
    desc: "Aprove quem entrar, defina cargo e permissões, e a meta de cada pessoa no mês. É aqui também que se vê o relatório de produtividade.",
    descMobile: "Aprove quem entrar, defina cargo, permissões e metas. No celular, toque no menu (☰) aqui embaixo e escolha Equipe.",
  ...
  },
  {
    id: "rotina",
    title: "Rotina",
    desc: "A escala das tarefas recorrentes da agência, marcada dia a dia por quem fez.",
    descMobile: "A escala das tarefas recorrentes da agência. No celular, toque no menu (☰) aqui embaixo e escolha Rotina.",
  ...
  },
  {
    id: "ajuda",
    title: "Ajuda",
    desc: "No \"?\" do topo você acha tutoriais, refaz este tour e reporta um problema — com acompanhamento do status.",
    descMobile: "No \"?\" do topo você acha tutoriais, refaz este tour e reporta um problema.",
  ...
  },
  {
    id: "bell",
    title: "Notificações",
    desc: "Avisos de prazo, menções (@nome) e demandas novas chegam por aqui. Clicar leva direto pro item.",
  ...
  },
  {
    id: "settings",
    title: "Configurações",
    desc: "Equipe, Relatório, Jornada do cliente, Automações (Drive e lembretes), Plano e Cobrança, Margem por cliente, Afiliados, Revenda, Atualizações e a marca da agência (cores, logo, menu personalizado) — tudo fica aqui.",
    view: "settings",
  ...
  },
  {
    id: "done",
    title: "Tudo pronto! ✨",
    desc: "Pode refazer este tour quando quiser no \"?\" do topo, ou em Perfil. Boas entregas 💚",
  },
];
