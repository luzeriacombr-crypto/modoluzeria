    ...
    <div className="min-h-screen text-foreground" style={{ background: BG_BLUE, fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}>
      ...
      <main className="max-w-[720px] mx-auto px-5 sm:px-10 py-14">
        ...
        <div className="space-y-8 text-foreground/80 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground mb-2">2. Cadastro e responsabilidade da conta</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground mb-2">4. Seu conteúdo</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground mb-2">5. Uso aceitável</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground mb-2">6. Integrações com terceiros (Google Drive, Instagram)</h2>
            <p>
