  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Publicar no TikTok (só vídeo: Posts e Reels com vídeo anexado, mesma permissão do Instagram) — app aprovado pelo TikTok em 2026-09-24, liberado pra todas as agências */}
